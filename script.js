document.addEventListener('DOMContentLoaded', () => {
    ...
    function checkCertificate(dni) {
        // Logic: Valid only if it matches the specific DNI for the demo
        // In reality, this would check if the file exists or query an API
        ...
        if (dni === '72604038') {
            ...
            // Name to display
            const participantName = "Gabriela Nhia Quiñonez Chuquitapa";
